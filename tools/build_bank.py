...
def classify_question(raw_text: str) -> dict:
    ...
    rules = [
        ...
        ("semiconductor", "bands", "원자·에너지대", ["에너지대", "에너지 밴드", "energy band", "페르미", "가전자대", "전도대", "밴드갭"]),
        ("semiconductor", "materials", "반도체 물성", ["진성반도체", "불순물 반도체", "n형", "p형", "캐리어", "정공", "이동도", "전도도"]),
        ("semiconductor", "phenomena", "반도체 현상", ["광전효과", "열전효과", "홀효과", "hall effect", "재결합"]),
        ("semiconductor", "pn-junction", "PN 접합", ["pn 접합", "공핍층", "확산전위", "순방향 바이어스", "역방향 바이어스"]),
        ("semiconductor", "power-devices", "특수·전력반도체", ["scr", "triac", "diac", "igbt", "thyristor", "사이리스터", "ujt"]),
        ("semiconductor", "fet-device", "FET·MOSFET 소자이론", ["mosfet", "jfet", "전계효과", "문턱전압", "pinch-off", "핀치오프", "공핍형", "증가형"]),
        ("semiconductor", "bjt-device", "BJT 소자이론", ["bjt", "베이스 전류", "컬렉터 전류", "이미터 전류", "활성영역", "포화영역", "차단영역"]),
        ("semiconductor", "diode-devices", "다이오드 소자", ["제너 다이오드", "터널 다이오드", "버랙터", "쇼트키", "led", "포토다이오드", "다이오드의 특성"]),
        ("semiconductor", "fabrication", "집적회로·공정", ["웨이퍼", "도핑", "이온주입", "산화막", "반도체 공정", "집적도", "패키징"]),
    ...
    topic_migrations = {
        ...
        "diode-devices": "special-diodes", "materials": "carriers", "fet-device": "mosfet-device",
