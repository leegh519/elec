...
RULES = [
    ...
    rule("electronic-circuits", "special-devices", "쇼트키 다이오드", r"쇼트키", r"터널\s*다이오드", r"버랙터", r"가변\s*용량\s*다이오드"),
    ...
    rule("electronic-circuits", "fet-device", "증가형·공핍형", r"mos(?:fet|pet)?", r"문턱\s*전압", r"threshold", r"증가형", r"공핍형", r"채널\s*길이\s*변조"),
    rule("electronic-circuits", "fet-device", "MOS 커패시터", r"mos\s*(커패시터|구조)", r"축적.*공핍.*반전"),
    rule("electronic-circuits", "special-devices", "SCR·TRIAC·DIAC", r"\bscr\b", r"triac", r"diac", r"thyristor", r"사이리스터", r"\bujt\b", r"\bigbt\b"),
    rule("electronic-circuits", "fabrication", "웨이퍼·도핑", r"웨이퍼", r"이온\s*주입", r"반도체\s*공정", r"패키징", r"확산\s*공정", r"포토리소", r"포토레지스트", r"cmos\s*공정"),

    # 전자회로.
    rule("electronic-circuits", "rectifier", "반파정류", r"반파\s*정류", r"전파\s*정류", r"브리[지릿]\s*정류", r"정류\s*회로", r"정류기", r"배전압"),
    rule("electronic-circuits", "smoothing", "리플", r"리플\s*(전압|률)", r"ripple\s*(voltage|factor)", r"맥동률", r"평활", r"커패시터\s*입력\s*필터"),
    rule("electronic-circuits", "smoothing", "첨두값 검출", r"첨두값\s*검출", r"피크\s*검출", r"peak\s*detector"),
    rule("electronic-circuits", "limiter-clamper", "리미터·클리퍼", r"리미터", r"limiter", r"클리퍼", r"clipper", r"제한\s*전압"),
    rule("electronic-circuits", "limiter-clamper", "양·음 클램퍼", r"클램퍼", r"clamper", r"클램프\s*회로", r"직류\s*레벨\s*이동"),
    rule("electronic-circuits", "zener-regulator", "제너 다이오드", r"제너", r"zener"),
...
OLD_TOPIC_FALLBACK = {
    ...
    "fabrication": ("electronic-circuits", "fabrication"), "diode-applications": ("electronic-circuits", "rectifier"),
...
ID_OVERRIDES = {
    ...
    "national-2008-18": ("electronic-circuits", ["limiter-clamper"]),
    ...
    "national-2011-10": ("electronic-circuits", ["comparator-schmitt", "zener-regulator"]),
    ...
    "national-2011-07": ("electronic-circuits", ["opamp-operations", "limiter-clamper"]),
    "national-2011-09": ("electronic-circuits", ["bjt-device"]),
    "local-2012-16": ("electronic-circuits", ["limiter-clamper"]),
    "national-2012-08": ("circuit-theory", ["node-analysis"]),
    "national-2013-08": ("electronic-circuits", ["smoothing", "opamp-operations"]),
    "national-2013-18": ("electronic-circuits", ["rectifier"]),
    ...
    "assembly-2014-10": ("electronic-circuits", ["limiter-clamper"]),
    ...
    "assembly-2019-09": ("electronic-circuits", ["fabrication"]),
    ...
    "assembly-2009-12": ("electronic-circuits", ["rectifier"]),
    "assembly-2009-18": ("electronic-circuits", ["limiter-clamper"]),
    ...
    "assembly-2016-20": ("electronic-circuits", ["limiter-clamper"]),
    "assembly-2017-01": ("electronic-circuits", ["rectifier"]),
    ...
    "assembly-2018-05": ("electronic-circuits", ["limiter-clamper"]),
    "assembly-2018-09": ("digital-engineering", ["logic-families", "boolean-gates"]),
    "assembly-2018-13": ("electronic-circuits", ["limiter-clamper", "zener-regulator"]),
    ...
    "assembly-2020-14": ("electronic-circuits", ["limiter-clamper"]),
    "assembly-2020-15": ("electronic-circuits", ["diode-basics"]),
    "assembly-2020-16": ("electronic-circuits", ["rectifier", "power-supply-regulator"]),
    ...
    "assembly-2022-08": ("electronic-circuits", ["limiter-clamper", "zener-regulator"]),
    "assembly-2022-10": ("electronic-circuits", ["limiter-clamper", "opamp-operations"]),
    ...
    "assembly-2024-06": ("electronic-circuits", ["limiter-clamper"]),
    "assembly-2024-07": ("electronic-circuits", ["opamp-operations"]),
    "assembly-2024-08": ("electronic-circuits", ["rectifier"]),
    ...
    "seoul-2018-07": ("electronic-circuits", ["rectifier"]),
    ...
    "seoul-2020-11": ("electronic-circuits", ["zener-regulator"]),
    ...
    "seoul-2021-20": ("electronic-circuits", ["comparator-schmitt", "limiter-clamper", "zener-regulator"]),
    "assembly-2009-01": ("electronic-circuits", ["diode-basics"]),
    "assembly-2009-13": ("electronic-circuits", ["diode-basics"]),
    "assembly-2015-08": ("electronic-circuits", ["limiter-clamper", "zener-regulator"]),
    "assembly-2015-11": ("electronic-circuits", ["semiconductor-basics", "diode-basics"]),
    "assembly-2017-11": ("electronic-circuits", ["limiter-clamper"]),
    "assembly-2018-03": ("electronic-circuits", ["rectifier"]),
    "assembly-2019-11": ("electronic-circuits", ["special-devices", "zener-regulator"]),
    "assembly-2019-16": ("electronic-circuits", ["limiter-clamper"]),
    "assembly-2020-01": ("electronic-circuits", ["semiconductor-basics"]),
    "assembly-2021-02": ("electronic-circuits", ["smoothing"]),
    "assembly-2021-06": ("electronic-circuits", ["diode-basics"]),
    "assembly-2021-13": ("electronic-circuits", ["zener-regulator"]),
    "assembly-2021-18": ("electronic-circuits", ["smoothing"]),
    "assembly-2022-01": ("electronic-circuits", ["limiter-clamper"]),
    "assembly-2023-13": ("electronic-circuits", ["semiconductor-basics", "diode-basics"]),
    "assembly-2024-03": ("electronic-circuits", ["limiter-clamper"]),
    "assembly-2024-15": ("electronic-circuits", ["semiconductor-basics"]),
    "local-2009-14": ("electronic-circuits", ["diode-basics"]),
    "local-2009-15": ("electronic-circuits", ["rectifier"]),
    "local-2010-10": ("electronic-circuits", ["rectifier"]),
    "local-2010-12": ("electronic-circuits", ["diode-basics"]),
    "local-2010-17": ("electronic-circuits", ["diode-basics"]),
    "local-2010-20": ("electronic-circuits", ["diode-basics", "special-devices", "zener-regulator"]),
    "local-2011-02": ("electronic-circuits", ["rectifier", "smoothing"]),
    "local-2011-16": ("electronic-circuits", ["special-devices", "bjt-device"]),
    "local-2011-17": ("electronic-circuits", ["limiter-clamper"]),
    "local-2012-05": ("electronic-circuits", ["special-devices"]),
    "local-2012-08": ("electronic-circuits", ["limiter-clamper"]),
    "local-2012-12": ("electronic-circuits", ["special-devices"]),
    "local-2012-15": ("electronic-circuits", ["diode-basics"]),
    "local-2022-04": ("electronic-circuits", ["diode-basics"]),
    "local-2022-06": ("electronic-circuits", ["rectifier"]),
    "local-2022-07": ("electronic-circuits", ["diode-basics"]),
    "local-2022-19": ("electronic-circuits", ["limiter-clamper"]),
    "local-2023-10": ("electronic-circuits", ["diode-basics"]),
    "local-2023-13": ("electronic-circuits", ["rectifier"]),
    "local-2023-14": ("electronic-circuits", ["diode-basics"]),
    "local-2024-12": ("electronic-circuits", ["limiter-clamper"]),
    "local-2024-20": ("electronic-circuits", ["smoothing"]),
    "local-2025-06": ("electronic-circuits", ["rectifier"]),
    "local-2025-09": ("electronic-circuits", ["smoothing"]),
    "local-2025-10": ("electronic-circuits", ["limiter-clamper"]),
    "local-2025-12": ("electronic-circuits", ["zener-regulator", "power-supply-regulator"]),
    "local-2026-05": ("electronic-circuits", ["rectifier"]),
    "local-2026-06": ("electronic-circuits", ["diode-basics"]),
    "local-2026-13": ("electronic-circuits", ["diode-basics"]),
    "military-2022-16": ("electronic-circuits", ["semiconductor-basics"]),
    "military-2023-07": ("electronic-circuits", ["diode-basics"]),
    "military-2023-09": ("electronic-circuits", ["semiconductor-basics"]),
    "military-2023-18": ("electronic-circuits", ["zener-regulator"]),
    "military-2023-19": ("electronic-circuits", ["rectifier"]),
    "military-2024-01": ("electronic-circuits", ["semiconductor-basics"]),
    "military-2024-02": ("electronic-circuits", ["diode-basics"]),
    "military-2024-03": ("electronic-circuits", ["fet-device"]),
    "military-2024-05": ("electronic-circuits", ["diode-basics"]),
    "military-2024-15": ("electronic-circuits", ["rectifier"]),
    "military-2025-05": ("electronic-circuits", ["diode-basics"]),
    "military-2025-09": ("electronic-circuits", ["semiconductor-basics"]),
    "military-2025-11": ("electronic-circuits", ["smoothing"]),
    "military-2025-17": ("electronic-circuits", ["limiter-clamper", "zener-regulator"]),
    "military-2026-01": ("electronic-circuits", ["semiconductor-basics"]),
    "military-2026-04": ("electronic-circuits", ["bjt-device", "special-devices"]),
    "military-2026-17": ("electronic-circuits", ["semiconductor-basics"]),
    "national-2007-05": ("electronic-circuits", ["special-devices", "zener-regulator"]),
    "national-2007-20": ("electronic-circuits", ["special-devices"]),
    "national-2008-02": ("electronic-circuits", ["zener-regulator"]),
    "national-2008-06": ("electronic-circuits", ["rectifier"]),
    "national-2009-06": ("electronic-circuits", ["bjt-device", "fet-device"]),
    "national-2009-10": ("electronic-circuits", ["limiter-clamper"]),
    "national-2010-05": ("electronic-circuits", ["zener-regulator"]),
    "national-2010-06": ("electronic-circuits", ["smoothing"]),
    "national-2011-08": ("electronic-circuits", ["semiconductor-basics"]),
    "national-2011-13": ("electronic-circuits", ["limiter-clamper", "opamp-operations"]),
    "national-2011-14": ("electronic-circuits", ["fet-device"]),
    "national-2011-15": ("electronic-circuits", ["special-devices"]),
    "national-2012-04": ("electronic-circuits", ["diode-basics"]),
    "national-2012-06": ("electronic-circuits", ["diode-basics"]),
    "national-2012-19": ("electronic-circuits", ["special-devices"]),
    "national-2013-01": ("electronic-circuits", ["semiconductor-basics"]),
    "national-2013-03": ("electronic-circuits", ["special-devices"]),
    "national-2013-20": ("electronic-circuits", ["diode-basics"]),
    "national-2014-02": ("electronic-circuits", ["diode-basics"]),
    "national-2014-11": ("electronic-circuits", ["special-devices", "zener-regulator"]),
    "national-2014-13": ("electronic-circuits", ["diode-basics"]),
    "national-2014-14": ("electronic-circuits", ["semiconductor-basics"]),
    "national-2015-10": ("electronic-circuits", ["fet-device"]),
    "national-2015-18": ("electronic-circuits", ["bjt-device"]),
    "national-2015-20": ("electronic-circuits", ["semiconductor-basics"]),
    "national-2016-02": ("electronic-circuits", ["diode-basics"]),
    "national-2016-11": ("electronic-circuits", ["rectifier"]),
    "national-2016-13": ("electronic-circuits", ["fet-device"]),
    "national-2017-06": ("electronic-circuits", ["fet-device"]),
    "national-2017-07": ("electronic-circuits", ["limiter-clamper", "zener-regulator"]),
    "national-2018-02": ("electronic-circuits", ["bjt-device", "fet-device"]),
    "national-2018-04": ("electronic-circuits", ["diode-basics", "special-devices", "zener-regulator"]),
    "national-2019-02": ("electronic-circuits", ["diode-basics"]),
    "national-2019-13": ("electronic-circuits", ["rectifier", "smoothing"]),
    "national-2019-17": ("electronic-circuits", ["bjt-device"]),
    "national-2020-06": ("electronic-circuits", ["diode-basics"]),
    "national-2020-14": ("electronic-circuits", ["limiter-clamper", "opamp-operations", "zener-regulator"]),
    "national-2020-19": ("electronic-circuits", ["special-devices"]),
    "national-2021-11": ("electronic-circuits", ["zener-regulator"]),
    "national-2021-17": ("electronic-circuits", ["diode-basics"]),
    "national-2022-02": ("electronic-circuits", ["diode-basics"]),
    "national-2022-05": ("electronic-circuits", ["limiter-clamper"]),
    "national-2022-13": ("electronic-circuits", ["zener-regulator"]),
    "national-2023-04": ("electronic-circuits", ["semiconductor-basics"]),
    "national-2023-09": ("electronic-circuits", ["diode-basics"]),
    "national-2023-16": ("electronic-circuits", ["diode-basics"]),
    "national-2023-20": ("electronic-circuits", ["zener-regulator"]),
    "national-2024-04": ("electronic-circuits", ["fet-device"]),
    "national-2024-12": ("electronic-circuits", ["diode-basics"]),
    "national-2024-17": ("electronic-circuits", ["special-devices"]),
    "national-2025-08": ("electronic-circuits", ["rectifier"]),
    "national-2025-20": ("electronic-circuits", ["zener-regulator"]),
    "national-2026-05": ("electronic-circuits", ["limiter-clamper"]),
    "national-2026-08": ("electronic-circuits", ["diode-basics", "zener-regulator"]),
    "national-2026-12": ("electronic-circuits", ["bjt-device", "fet-device"]),
    "seoul-2014-17": ("electronic-circuits", ["limiter-clamper"]),
    "seoul-2015-04": ("electronic-circuits", ["semiconductor-basics"]),
    "seoul-2015-18": ("electronic-circuits", ["diode-basics"]),
    "seoul-2017-15": ("electronic-circuits", ["semiconductor-basics"]),
    "seoul-2018-01": ("electronic-circuits", ["semiconductor-basics"]),
    "seoul-2020-02": ("electronic-circuits", ["semiconductor-basics"]),
    "seoul-2020-03": ("electronic-circuits", ["special-devices"]),
    "seoul-2020-06": ("electronic-circuits", ["limiter-clamper"]),
}
...
CONCEPT_OVERRIDES = {
    ...
    "assembly-2009-01": ["전류·전압 특성"],
    "assembly-2009-12": ["반파정류"],
    "assembly-2009-13": ["공핍층"],
    "assembly-2009-18": ["직렬·병렬 리미터"],
    "assembly-2014-10": ["양·음 클램퍼"],
    "assembly-2015-08": ["직렬·병렬 리미터", "제너 리미터"],
    "assembly-2015-11": ["진성·불순물 반도체", "공핍층"],
    "assembly-2016-01": ["터널 다이오드"],
    "assembly-2016-20": ["직렬·병렬 리미터"],
    "assembly-2017-01": ["반파정류"],
    "assembly-2017-11": ["직렬·병렬 리미터"],
    "assembly-2018-03": ["반파정류"],
    "assembly-2018-05": ["양·음 클램퍼"],
    "assembly-2018-13": ["직렬·병렬 리미터", "제너 리미터"],
    "assembly-2019-08": ["진성·불순물 반도체"],
    "assembly-2019-09": ["포토레지스트"],
    "assembly-2019-11": ["제너 다이오드"],
    "assembly-2019-16": ["양·음 클램퍼"],
    "assembly-2020-01": ["진성·불순물 반도체"],
    "assembly-2020-14": ["직렬·병렬 리미터"],
    "assembly-2020-15": ["공핍층", "전류·전압 특성"],
    "assembly-2020-16": ["반파정류", "선형·직렬·병렬 조정기"],
    "assembly-2021-02": ["커패시터 입력필터", "리플"],
    "assembly-2021-06": ["전류·전압 특성"],
    "assembly-2021-13": ["제너 정전압"],
    "assembly-2021-18": ["LC 평활필터"],
    "assembly-2022-01": ["직렬·병렬 리미터"],
    "assembly-2022-08": ["직렬·병렬 리미터", "제너 정전압"],
    "assembly-2022-10": ["양·음 클램퍼", "반전·비반전"],
    "assembly-2023-13": ["진성·불순물 반도체", "공핍층"],
    "assembly-2023-17": ["확산·드리프트"],
    "assembly-2024-03": ["직렬·병렬 리미터"],
    "assembly-2024-06": ["직렬·병렬 리미터"],
    "assembly-2024-08": ["반파정류"],
    "assembly-2024-15": ["진성·불순물 반도체"],
    "assembly-2025-12": ["진성·불순물 반도체"],
    "assembly-2025-18": ["제너 정전압"],
    "local-2009-14": ["공핍층"],
    "local-2009-15": ["반파정류"],
    "local-2010-10": ["반파정류"],
    "local-2010-12": ["공핍층"],
    "local-2010-17": ["공핍층", "순·역방향 바이어스", "전류·전압 특성"],
    "local-2010-20": ["공핍층", "제너 다이오드", "LED"],
    "local-2011-02": ["전파정류", "평활필터", "리플"],
    "local-2011-16": ["LED", "BJT 구조·동작"],
    "local-2011-17": ["직렬·병렬 리미터"],
    "local-2012-05": ["LED"],
    "local-2012-08": ["직렬·병렬 리미터"],
    "local-2012-12": ["LED"],
    "local-2012-15": ["공핍층"],
    "local-2012-16": ["직렬·병렬 리미터"],
    "local-2022-04": ["전류·전압 특성"],
    "local-2022-06": ["반파정류"],
    "local-2022-07": ["공핍층"],
    "local-2022-19": ["직렬·병렬 리미터"],
    "local-2023-10": ["전류·전압 특성"],
    "local-2023-13": ["반파정류"],
    "local-2023-14": ["전류·전압 특성"],
    "local-2024-12": ["직렬·병렬 리미터"],
    "local-2024-20": ["커패시터 입력필터", "리플"],
    "local-2025-06": ["반파정류"],
    "local-2025-09": ["맥동률"],
    "local-2025-10": ["직렬·병렬 리미터"],
    "local-2025-12": ["제너 정전압", "선형·직렬·병렬 조정기"],
    "local-2026-05": ["반파정류"],
    "local-2026-06": ["전류·전압 특성"],
    "local-2026-13": ["전류·전압 특성"],
    "military-2022-06": ["LED"],
    "military-2022-16": ["진성·불순물 반도체"],
    "military-2023-07": ["공핍층"],
    "military-2023-09": ["진성·불순물 반도체"],
    "military-2023-18": ["제너 다이오드", "제너 정전압"],
    "military-2023-19": ["반파정류"],
    "military-2024-01": ["진성·불순물 반도체"],
    "military-2024-02": ["공핍층"],
    "military-2024-03": ["채널", "문턱전압"],
    "military-2024-05": ["공핍층"],
    "military-2024-15": ["반파정류"],
    "military-2025-05": ["공핍층", "순·역방향 바이어스", "전류·전압 특성"],
    "military-2025-09": ["진성·불순물 반도체"],
    "military-2025-11": ["커패시터 입력필터", "리플"],
    "military-2025-17": ["직렬·병렬 리미터", "제너 리미터"],
    "military-2026-01": ["에너지대"],
    "military-2026-04": ["BJT 구조·동작", "LED"],
    "military-2026-17": ["진성·불순물 반도체"],
    "national-2007-05": ["제너 다이오드", "LED"],
    "national-2007-20": ["LED"],
    "national-2008-02": ["제너 정전압"],
    "national-2008-06": ["반파정류"],
    "national-2008-18": ["양·음 클램퍼"],
    "national-2009-06": ["BJT 구조·동작", "증가형·공핍형"],
    "national-2009-10": ["직렬·병렬 리미터"],
    "national-2010-05": ["제너 정전압"],
    "national-2010-06": ["커패시터 입력필터", "리플"],
    "national-2011-07": ["반전·비반전", "직렬·병렬 리미터"],
    "national-2011-08": ["진성·불순물 반도체"],
    "national-2011-10": ["슈미트 트리거", "히스테리시스", "제너 리미터"],
    "national-2011-13": ["직렬·병렬 리미터", "반전·비반전"],
    "national-2011-14": ["채널", "문턱전압"],
    "national-2011-15": ["버랙터 다이오드"],
    "national-2012-04": ["전류·전압 특성"],
    "national-2012-06": ["전류·전압 특성"],
    "national-2012-19": ["LED"],
    "national-2013-01": ["진성·불순물 반도체"],
    "national-2013-03": ["버랙터 다이오드"],
    "national-2013-08": ["첨두값 검출", "전압추종기"],
    "national-2013-18": ["반파정류"],
    "national-2013-20": ["전류·전압 특성"],
    "national-2014-02": ["전류·전압 특성"],
    "national-2014-11": ["제너 다이오드"],
    "national-2014-13": ["공핍층", "순·역방향 바이어스", "전류·전압 특성"],
    "national-2014-14": ["에너지대", "진성·불순물 반도체"],
    "national-2015-10": ["MOS 커패시터", "축적·공핍·반전"],
    "national-2015-18": ["BJT 구조·동작", "전류 관계"],
    "national-2015-20": ["에너지대"],
    "national-2016-02": ["공핍층"],
    "national-2016-09": ["제너 정전압"],
    "national-2016-11": ["반파정류"],
    "national-2016-13": ["채널", "문턱전압"],
    "national-2017-06": ["전달컨덕턴스"],
    "national-2017-07": ["바이어스 리미터", "제너 리미터"],
    "national-2018-02": ["BJT 구조·동작", "증가형·공핍형"],
    "national-2018-04": ["공핍층", "제너 다이오드"],
    "national-2019-02": ["공핍층", "순·역방향 바이어스", "전류·전압 특성"],
    "national-2019-13": ["전파정류", "평활필터", "리플"],
    "national-2019-17": ["BJT 구조·동작", "전류 관계"],
    "national-2020-06": ["전류·전압 특성"],
    "national-2020-14": ["직렬·병렬 리미터", "반전·비반전", "제너 리미터"],
    "national-2020-19": ["SCR·TRIAC·DIAC"],
    "national-2021-11": ["제너 다이오드", "제너 정전압"],
    "national-2021-17": ["전류·전압 특성"],
    "national-2022-02": ["공핍층", "순·역방향 바이어스", "전류·전압 특성"],
    "national-2022-05": ["직렬·병렬 리미터"],
    "national-2022-13": ["제너 다이오드", "제너 정전압"],
    "national-2023-04": ["진성·불순물 반도체", "에너지대"],
    "national-2023-09": ["공핍층"],
    "national-2023-16": ["공핍층"],
    "national-2023-20": ["제너 다이오드", "제너 정전압"],
    "national-2024-04": ["JFET", "핀치오프"],
    "national-2024-12": ["공핍층"],
    "national-2024-17": ["SCR·TRIAC·DIAC"],
    "national-2025-08": ["반파정류"],
    "national-2025-20": ["제너 다이오드", "제너 정전압"],
    "national-2026-05": ["직렬·병렬 리미터"],
    "national-2026-08": ["공핍층", "제너 다이오드"],
    "national-2026-12": ["BJT 구조·동작", "증가형·공핍형"],
    "seoul-2014-17": ["직렬·병렬 리미터"],
    "seoul-2015-03": ["제너 정전압"],
    "seoul-2015-04": ["진성·불순물 반도체"],
    "seoul-2015-18": ["공핍층", "순·역방향 바이어스", "전류·전압 특성"],
    "seoul-2016-11": ["공핍층"],
    "seoul-2017-15": ["진성·불순물 반도체"],
    "seoul-2018-01": ["확산·드리프트"],
    "seoul-2018-07": ["반파정류"],
    "seoul-2019-05": ["확산·드리프트"],
    "seoul-2019-08": ["공핍층"],
    "seoul-2020-02": ["진성·불순물 반도체"],
    "seoul-2020-03": ["버랙터 다이오드"],
    "seoul-2020-06": ["직렬·병렬 리미터"],
    "seoul-2020-11": ["제너 다이오드", "제너 정전압"],
    "seoul-2021-20": ["비교기", "직렬·병렬 리미터", "제너 리미터"],
}
...
def generic_fallback(text: str) -> tuple[str, list[str]] | None:
    ...
    if re.search(r"다이오드", text):
        if re.search(r"파형|전달\s*특성|출력\s*전압", text):
            return "electronic-circuits", ["limiter-clamper"]
...
def classify(question: dict, topic_index: dict) -> dict:
    ...
    for category, topic, concept, patterns in RULES:
        # 소자의 캐리어·N/P형 설명을 반도체 물성 문제로 중복 분류하지 않는다.
        if topic == "semiconductor-basics" and re.search(r"mos|jfet|mesfet|bjt|트랜지스터|바이폴라", text):
            continue
